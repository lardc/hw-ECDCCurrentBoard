...
void MEASURE_ReadDutCurrent(float Current)
{
	if(Current<=I_RANGE_20MA)
	{
		...
		REG_ADC_ID20MA_OFFSET, REG_ADC_ID20MA_K, REG_ADC_ID20MA_FINE_P0, REG_ADC_ID20MA_FINE_P1, REG_ADC_ID20MA_FINE_P2);
	}
	else if(Current<=I_RANGE_200MA)
	{
		MEASURE_ConvertRawArray(&CONTROL_DUTCurrentRaw[0], &CONTROL_ValuesDUTCurrent[0], VALUES_OUT_SIZE,
		REG_ADC_ID200MA_OFFSET, REG_ADC_ID200MA_K, REG_ADC_ID200MA_FINE_P0, REG_ADC_ID200MA_FINE_P1, REG_ADC_ID200MA_FINE_P2);
	}
	...
	{
		MEASURE_ConvertRawArray(&CONTROL_DUTCurrentRaw[0], &CONTROL_ValuesDUTCurrent[0], VALUES_OUT_SIZE,
		REG_ADC_ID270A_OFFSET, REG_ADC_ID270A_K, REG_ADC_ID270A_FINE_P0, REG_ADC_ID270A_FINE_P1, REG_ADC_ID270A_FINE_P2);
	}
}
//---------------------
...
void MEASURE_ReadDutVoltage(float Voltage)
{
	if(Voltage<=V_RANGE_30MV)
	{
		...
		REG_ADC_VD30MV_OFFSET, REG_ADC_VD30MV_K, REG_ADC_VD30MV_FINE_P0, REG_ADC_VD30MV_FINE_P1, REG_ADC_VD30MV_FINE_P2);
	}
	else if(Voltage<=V_RANGE_250MV)
	{
		MEASURE_ConvertRawArray(&CONTROL_DUTVoltageRaw[0], &CONTROL_ValuesDUTVoltage[0], VALUES_OUT_SIZE,
		REG_ADC_VD250MV_OFFSET, REG_ADC_VD250MV_K, REG_ADC_VD250MV_FINE_P0, REG_ADC_VD250MV_FINE_P1, REG_ADC_VD250MV_FINE_P2);
	}
	else if(Voltage<=V_RANGE_1500MV)
	{
		MEASURE_ConvertRawArray(&CONTROL_DUTVoltageRaw[0], &CONTROL_ValuesDUTVoltage[0], VALUES_OUT_SIZE,
		REG_ADC_VD1500MV_OFFSET, REG_ADC_VD1500MV_K, REG_ADC_VD1500MV_FINE_P0, REG_ADC_VD1500MV_FINE_P1, REG_ADC_VD1500MV_FINE_P2);
	}
	else
	{
		MEASURE_ConvertRawArray(&CONTROL_DUTVoltageRaw[0], &CONTROL_ValuesDUTVoltage[0], VALUES_OUT_SIZE,
