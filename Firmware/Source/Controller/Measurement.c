...
void MEASURE_ConvertRawArray(volatile uint16_t *InputArray, float *OutputArray, uint16_t ArrayOffset,
		uint16_t DataLength, uint16_t RegisterOffset, uint16_t RegisterK, uint16_t RegisterP0, uint16_t RegisterP1,
		uint16_t RegisterP2)
{
	uint16_t i;
	float tmp;
...
{
	MEASURE_ConvertRawArray(InputArray, OutputArray, 0, DataLength, REG_ADC_ID2A_OFFSET, REG_ADC_ID2A_K,
...
{
	MEASURE_ConvertRawArray(InputArray, OutputArray, 0, DataLength, REG_ADC_ID270A_OFFSET, REG_ADC_ID270A_K,
...
{
	MEASURE_ConvertRawArray(InputArray, OutputArray, 1, DataLength, REG_ADC_VD250MV_OFFSET, REG_ADC_VD250MV_K,
...
{
	MEASURE_ConvertRawArray(InputArray, OutputArray, 1, DataLength, REG_ADC_VD11V_OFFSET, REG_ADC_VD11V_K,
